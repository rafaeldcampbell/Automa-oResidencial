...
if (DEVICE_TRANSPORT === 'HTTP') {
    debug('Listening on HTTP endpoints: /iot/bell, /iot/door, iot/lamp, iot/cafeteira, iot/cortina, iot/roboaspirador, iot/maqdelavar, iot/sensorpressao, iot/sensorpresenca');
    ...
    iotRouter.post('/iot/cafeteira:id', Southbound.cafeteiraHttpCommand);
    iotRouter.post('/iot/cortina:id', Southbound.cortinaHttpCommand);
    iotRouter.post('/iot/roboaspirador:id', Southbound.roboaspiradorHttpCommand);
    iotRouter.post('/iot/maqdelavar:id', Southbound.maqdelavarHttpCommand);
    iotRouter.post('/iot/sensorpressao:id', Southbound.sensorpressaoHttpCommand);
    iotRouter.post('/iot/sensorpresenca:id', Southbound.sensorpresencaHttpCommand);
