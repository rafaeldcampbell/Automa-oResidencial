...
module.exports = {
    ...
    // Nossa cafeteira
    cafeteiraHttpCommand(req, res) {
        debug('cafeteiraHttpCommand');
        return Command.actuateCafeteira(req, res);
    },

    // Nossa cortina
    cortinaHttpCommand(req, res) {
        debug('cortinaHttpCommand');
        return Command.actuateCortina(req, res);
    },

    // Nosso robo aspirador
    roboaspiradorHttpCommand(req, res) {
        debug('roboaspiradorHttpCommand');
        return Command.actuateRoboaspirador(req, res);
    },

    // Nossa Maquina de lavar
    maqdelavarHttpCommand(req, res) {
        debug('maqdelavarHttpCommand');
        return Command.actuateMaqdelavar(req, res);
    },

    // Nosso sensor de pressao
    sensorpressaoHttpCommand(req, res) {
        debug('sensorpressaoHttpCommand');
        return Command.actuateSensorpressao(req, res);
    },

    // Nosso sensor de presenca
    sensorpresencaHttpCommand(req, res) {
        debug('sensorpresencaHttpCommand');
        return Command.actuateSensorpresenca(req, res);
    },
